...
export const conditions = [
    {
        title: 'Diastema',
        description: 'refers to a gap between your teeth. Gaps can occur anywhere in your mouth, but they’re most common between your two front teeth. This condition is usually a cosmetic concern, but sometimes, it’s related to gum disease. Diastema treatments include dental bonding, porcelain veneers and braces.',
        img: Diastema
    },
    {
        title: "Malocclusion ",
    ...
    },
    {
        ...
        description: `
        is where a tooth has incompletely cracked but no part of the tooth has yet broken off. Sometimes it is described as a greenstick fracture. The symptoms are very variable, making it a notoriously difficult condition to diagnose.
