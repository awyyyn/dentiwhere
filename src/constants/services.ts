...
export const services = [
    {
        ...
        description: 'Tooth extraction is a dental procedure that involves removing a tooth from its socket in the jawbone, often due to severe decay, damage, or overcrowding.',
        /* 
    ...
    {
        title: 'Root canal',
        description: 'A root canal is a dental procedure designed to treat infection or damage within the pulp of a tooth, which is the innermost soft tissue containing nerves and blood vessels.',
        /* 
    ...
    {
        title: 'Dental crown',
        description: 'A dental crown is a cap placed over a tooth to restore its shape, size, strength, and appearance. It is typically used when a tooth is severely damaged, decayed, or after a root canal procedure.',
        /* 
    ...
    {
        title: 'Tooth filling',
        description: "A tooth filling is a dental treatment used to repair a cavity or a small area of decay in a tooth.",
        /* 
    ...
    {
        title: 'Full dentures',
        description: "Full dentures replace all missing teeth in either the upper or lower jaw, featuring a complete set of artificial teeth set in a pink acrylic base that mimics the gums.",
        /* 
    ...
    {
        title: 'Braces',
        description: "Braces are orthodontic devices used to correct misaligned teeth and jaws, improving both dental function and appearance.",
        /* 
