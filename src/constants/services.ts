...
export const services = [
    ...
    {
        title: 'Root canal',
        description: 'A root canal is a dental procedure designed to treat infection or damage within the pulp of a tooth, which is the innermost soft tissue containing nerves and blood vessels. The process involves removing the infected or damaged pulp, thoroughly cleaning and disinfecting the root canals, and then filling them with a biocompatible material to seal the space. This procedure helps save the tooth and alleviate pain caused by the infection or damage. After the root canal, the tooth is typically restored with a crown or filling to ensure its strength and functionality. The procedure is generally performed under local anesthesia to ensure patient comfort.',
        img: RootCanal 
    },
    {
        title: 'Dental crown',
        description: 'A dental crown is a cap placed over a tooth to restore its shape, size, strength, and appearance. It is typically used when a tooth is severely damaged, decayed, or after a root canal procedure. The crown covers the entire visible part of the tooth, providing protection and enhancing its function. To place a crown, the dentist first prepares the tooth by removing any damaged or decayed parts and shaping it to fit the crown. An impression of the tooth is then taken to create a custom-fitted crown, which is usually made from materials like porcelain, metal, or a combination of both. Once the crown is ready, it is cemented onto the prepared tooth, restoring its original function and appearance.',
        img: DentalCrown 
    },
    {
        title: 'Tooth filling',
        description: "A tooth filling is a dental treatment used to repair a cavity or a small area of decay in a tooth. The process involves removing the decayed portion of the tooth and then filling the empty space with a material that restores the tooth's structure and function. The filling material, which can be made from materials such as amalgam, composite resin, glass ionomer, or gold, is applied in layers and shaped to match the tooth's natural contours. Once the filling material is in place, it is hardened and polished to ensure a smooth finish. Tooth fillings help prevent further decay and restore the tooth's ability to chew and function normally.",
        img: ToothFilling 
    },
    {
        title: 'Full dentures',
        description: "Full dentures replace all missing teeth in either the upper or lower jaw, featuring a complete set of artificial teeth set in a pink acrylic base that mimics the gums. They are removable for cleaning and sleeping. Partial dentures, on the other hand, are used when some natural teeth remain, consisting of artificial teeth attached to a metal or acrylic framework that clasps onto the remaining teeth. Both types of dentures restore oral function, improve speech and appearance, and are custom-made for a comfortable fit.",
        img: FullDentures 
    },
    {
        title: 'Braces',
        description: "Braces are orthodontic devices used to correct misaligned teeth and jaws, improving both dental function and appearance. They consist of metal or ceramic brackets attached to the teeth, connected by wires that apply gentle pressure to gradually shift the teeth into their proper positions. Braces can also include rubber bands or other accessories to assist with alignment. The treatment typically involves regular adjustments by an orthodontist to ensure the teeth move as planned. Braces help address issues such as overcrowding, gaps, and bite problems, leading to a more balanced and attractive smile.",
        img: Braces 
    },
]