...
export default function ListOfClinics() {
    ...
    return ( 
        <div className='mx-auto  w-11/12 md:w-10/12 py-20 space-y-5 md:space-y-10'> 
            <SectionHeader
            ...
            <div className='space-y-12 flex flex-col'>  
                ...
                <div className="self-center">
                    <Button className=" bg-[#58D4E8] hover:bg-[#58D4E8] rounded-full text-white hover:shadow-lg hover:shadow-gray-300  transition-all duration-300">
